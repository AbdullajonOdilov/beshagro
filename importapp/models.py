...
#     Name = models.CharField(verbose_name="Name", max_length=255)
#     Image = models.ImageField(verbose_name="Image", upload_to="OchiqAxborot")
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)
...
#     class Meta:
#         verbose_name = 'Oshkor axborot kategoriyasi'
#         verbose_name_plural = 'D - Oshkor axborotlar kategoriyasi'


# class DisclosureItems(models.Model):
#     Disclosure = models.ForeignKey(
#         InformationDisclosure, verbose_name="Category", on_delete=models.CASCADE)
#     Field_name = models.FileField(verbose_name="File(pdf, word, ...)", upload_to='DisclosureItems/files', max_length=254)
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)

#     def __str__(self):
#         return self.Disclosure.Name

#     class Meta:
#         verbose_name = 'Oshkor qilingan axborot'
#         verbose_name_plural = 'D - Oshkor qilingan axborotlar'


# class Shareholder(models.Model):
#     Name = models.CharField(verbose_name="Name", max_length=255)
#     Image = models.ImageField(verbose_name="Image", upload_to="Aksiya")
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)
...
#     class Meta:
#         verbose_name = 'Aksiyador'
#         verbose_name_plural = 'D- Aksiyadorlar kategoriyasi'


# class ShareholderItems(models.Model):
#     Shareholder = models.ForeignKey(
#         Shareholder, verbose_name="Main category", on_delete=models.CASCADE)
#     Field_name = models.FileField(verbose_name="File(pdf, word, ...)", upload_to='ShareholderItems/files', max_length=254)
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)

#     def __str__(self):
#         return self.Shareholder.Name

#     class Meta:
#         verbose_name = 'Aksiyador'
#         verbose_name_plural = 'D - Aksiyadorlar'


# class InternalDocumentsOfTheCompany(models.Model):
#     Name = models.CharField(verbose_name="Name", max_length=255)
#     Image = models.ImageField(verbose_name="Image", upload_to="Aksiya")
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)
...
#     class Meta:
#         verbose_name = 'Kompaniyaning ichki hujjat kategoriyasi'
#         verbose_name_plural = 'D - Kompaniyaning ichki hujjatlar kategoriyasi'


# class InternalDocumentsItems(models.Model):
#     InternalDocuments = models.ForeignKey(
#         InternalDocumentsOfTheCompany, verbose_name="Main category", on_delete=models.CASCADE)
#     Field_name = models.FileField(verbose_name="File(pdf, word, ...)", upload_to='InternalDocumentsItems/files', max_length=254)
#     Date = models.DateTimeField(verbose_name="Date", auto_now_add=True)

#     def __str__(self):
#         return self.InternalDocuments.Name

#     class Meta:
#         verbose_name = 'Kompaniyaning ichki hujjati'
#         verbose_name_plural = 'C - Kompaniyaning ichki hujjatlari'
